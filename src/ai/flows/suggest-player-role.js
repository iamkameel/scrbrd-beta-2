...
const SuggestPlayerRoleInputSchema = z.object({
    ...
    playerStatistics: z
        .string()
        .describe('The career statistics of the player, including runs, wickets, catches, and any other relevant information.'),
    playerSkills: z
        .string()
...
const SuggestPlayerRoleOutputSchema = z.object({
    suggestedRole: z
        .string()
        .describe('The AI-suggested playing role for the player, along with a brief explanation of why this role is suitable.'),
});
export async function suggestPlayerRole(input) {
