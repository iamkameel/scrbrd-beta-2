...
export default function ScorerDetailPage() {
    ...
    const scorerId = params.scorerId;
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="md:col-span-2 space-y-6">
          ...
          <Card>
            ...
            <CardContent>
              {scorer.recentMatchesScored.length > 0 ? (<div className="space-y-4">
                  {scorer.recentMatchesScored.map((match) => (<Card key={match.fixtureId} className="bg-muted/30 p-4 shadow-sm">
        ...
        <div className="space-y-6">
          <Card>
            ...
            <CardContent className="divide-y divide-border">
              ...
              {scorer.reliabilityScore !== undefined && (<DetailItem label="Reliability Score" value={<div className="flex items-center gap-2">
                      <span>{scorer.reliabilityScore}/100</span>
                      <Star className="h-4 w-4 text-yellow-500"/>
                    </div>} icon={Star}/>)}
              {scorer.associatedSchoolOrClub && (<DetailItem label="Primary Affiliation" value={scorer.associatedSchoolOrClub} icon={Building}/>)}
            </CardContent>
          </Card>
