...
const updateFixture = async ({ fixtureId, updatedData }) => {
    const fixtureDocRef = doc(db, 'fixtures', fixtureId);
...
export default function EditFixturePage() {
    ...
    const { data: fixture, isLoading, isError, error } = useQuery({
    ...
    if (!fixture) {
        return (<Card className="border-orange-500">
                <CardHeader>
    ...
    return (<Card className="w-full max-w-2xl mx-auto">
     ...
     // Corrected 'mutation.isLoading' to 'mutation.isPending'
