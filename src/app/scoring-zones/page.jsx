    ...
    return (<div className="space-y-6">
      <Card>
        ...
        <CardContent className="text-center">
           <Image src="https://placehold.co/600x400.png" alt="Scoring Zones Placeholder" width={600} height={400} className="mx-auto my-6 rounded-lg shadow-md" data-ai-hint="data analytics"/>
