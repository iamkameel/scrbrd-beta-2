...
import Image from 'next/image'; // Keep if needed for other images
import { umpiresData, type UmpireProfile, type OfficiatedMatch } from '@/lib/umpire-data';
import { Card, CardContent, CardHeader, CardTitle, CardDescription } from "@/components/ui/card";
import { Avatar, AvatarFallback, AvatarImage } from "@/components/ui/avatar";
import { Button } from "@/components/ui/button";
import { Badge } from "@/components/ui/badge";
import { ArrowLeft, Mail, Phone, ShieldCheck, CalendarClock, CheckCircle, Star, ListChecks, Info, Building, Briefcase, FileText, ShieldHalf } from "lucide-react"; // Added ShieldHalf
