...
const teamsData = [
  { id: 1, teamName: "1st XI", affiliation: "Northwood School", ageGroup: "Open", division: "A", mascot: "Knights" }, // Changed mascot to Knights to match original context for Northwood
...
export default function TeamsPage() {
  ...
  const uniqueAgeGroups = React.useMemo(() => {
    ...
    return ["all", ...Array.from(ageGroups)];
  }, []);
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="outline">
                  ...
                  Filter by Age Group {ageGroupFilter !== "all" ? `(${ageGroupFilter})` : ""}
                </Button>
              </DropdownMenuTrigger>
