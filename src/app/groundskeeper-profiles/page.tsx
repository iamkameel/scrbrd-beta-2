      ...
      <Card>
        ...
        <CardContent>
          ...
          {filteredGroundskeepers.length > 0 ? (
                ...
                <Card key={gk.id} className="hover:shadow-lg transition-shadow flex flex-col">
                  ...
                  <CardContent className="flex-grow py-3 space-y-2">
                     ...
                     {gk.assignedFields.length > 0 && (
                        <p className="text-sm text-muted-foreground pt-1">Manages: {gk.assignedFields[0].fieldName} ({gk.assignedFields[0].location}) {gk.assignedFields.length > 1 ? ` & ${gk.assignedFields.length-1} more`: ''}</p>
                     )}
                  </CardContent>
            ...
            <p className="text-center text-muted-foreground py-4">No groundskeepers found matching your search.</p>
          )}
        </CardContent>
      </Card>
    </div>
