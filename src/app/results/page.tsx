    ...
    <div className="space-y-6">
      <Card>
        ...
        <CardContent>
          <div className="space-y-6">
            {results.length > 0 ? (
              results.map((result: ResultWithTeamNames) => (
                <Card key={result.id} className="hover:shadow-md transition-shadow">
                  ...
                  <CardContent>
                    ...
                    {result.playerOfTheMatch && (
                        <div className="flex items-center text-sm text-muted-foreground bg-muted p-3 rounded-md mb-4">
              ...
              <p className="text-muted-foreground text-center italic py-4">No match results available at the moment.</p>
            )}
          </div>
        </CardContent>
      </Card>
