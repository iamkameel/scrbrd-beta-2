...
export const COACHING_STAFF_REGISTRY: Record<string, CoachingStaffMember[]> = {
  WES: [
    ...
    },
    {
      ...
      assignedSquads: ["WES_2ND"], primaryRole: "Coach", csaAccreditation: "CSA Level 2 (Advanced)", yearsExperience: 11,
    ...
    },
    {
      ...
      assignedSquads: ["WES_3RD", "WES_4TH"], primaryRole: "Coach", csaAccreditation: "CSA Level 2 (Advanced)", yearsExperience: 9,
    ...
    },
    {
      ...
      assignedSquads: ["WES_5TH", "WES_6TH", "WES_7TH"], primaryRole: "Coach", csaAccreditation: "Educator Coach", yearsExperience: 14,
    ...
    },
    {
      ...
      assignedSquads: ["WES_U16A"], primaryRole: "Coach", csaAccreditation: "CSA Level 3 (High Performance)", yearsExperience: 12,
    ...
    },
    {
      ...
      assignedSquads: ["WES_U16B", "WES_U16C", "WES_U16D"], primaryRole: "Coach", csaAccreditation: "CSA Level 2 (Advanced)", yearsExperience: 8,
    ...
    },
    {
      ...
      assignedSquads: ["WES_U15A"], primaryRole: "Coach", csaAccreditation: "CSA Level 3 (High Performance)", yearsExperience: 15,
    ...
    },
    {
      ...
      assignedSquads: ["WES_U15B", "WES_U15C"], primaryRole: "Coach", csaAccreditation: "CSA Level 2 (Advanced)", yearsExperience: 7,
    ...
    },
    {
      ...
      assignedSquads: ["WES_U15D", "WES_U15E"], primaryRole: "Coach", csaAccreditation: "CSA Level 1 (Foundation)", yearsExperience: 5,
    ...
    },
    {
      ...
      assignedSquads: ["WES_U14A"], primaryRole: "Coach", csaAccreditation: "CSA Level 3 (High Performance)", yearsExperience: 16,
    ...
    },
    {
      ...
      assignedSquads: ["WES_U14B", "WES_U14C"], primaryRole: "Coach", csaAccreditation: "CSA Level 2 (Advanced)", yearsExperience: 6,
    ...
    },
    {
      ...
      assignedSquads: ["WES_U14D", "WES_U14E", "WES_U14F", "WES_U14G"], primaryRole: "Coach", csaAccreditation: "Educator Coach", yearsExperience: 10,
